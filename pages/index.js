  ...
  const Timeline = ({ data }) => {
    ...
    return (
      <div className="bg-white p-4 rounded-lg shadow-md">
        ...
        <div 
          ref={timelineRef}
          className="relative h-16 bg-gray-200 rounded overflow-hidden"
        >
          {timelineData.map((item, index) => {
            const itemStart = new Date(item.startTime);
            if (itemStart < startTime || itemStart > endTime) return null;

            const leftPosition = (differenceInSeconds(itemStart, startTime) / totalDuration) * 100;
  ...
  return (
    <div className="min-h-screen bg-gray-100 py-8 px-4">
      <div className="max-w-6xl mx-auto">
        <h1 className="text-3xl font-bold text-center mb-8 text-gray-800">Operation Tracker</h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
          <div className="bg-white p-6 rounded-lg shadow-md">
            <h2 className="text-xl font-semibold mb-4">Operation Statistics</h2>
